...
@Composable
fun OnboardingPageDataUiModel.gradientOnboardingStart(): Color = when (this) {
...
@Composable
fun OnboardingPageDataUiModel.gradientOnboardingEnd(): Color = MaterialTheme.colorScheme.background

@Composable
fun OnboardingPageDataUiModel.imageOnboardingColor(): Color = when (this) {
