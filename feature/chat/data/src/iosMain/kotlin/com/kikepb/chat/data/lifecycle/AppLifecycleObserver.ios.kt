...
actual class AppLifecycleObserver {
    actual val isInForeground: Flow<Boolean> = callbackFlow {
        ...
        send(element = isCurrentlyInForeground)
        ...
        awaitClose {
            ...
            notificationCenter.removeObserver(observer = willEnterForegroundObserver)
            notificationCenter.removeObserver(observer = backgroundObserver)
            notificationCenter.removeObserver(observer = willResignActiveObserver)
        }
    }
}