...
fun PaginationScrollListener(
    ...
    val isPaginationLoading by rememberUpdatedState(newValue = isPaginationLoading)
    val isEndReached by rememberUpdatedState(newValue = isEndReached)

    var lastTriggerItemCount by remember { mutableIntStateOf(value = 0) }
    ...
    LaunchedEffect(key1 = lazyListState) {
        snapshotFlow {
            ...
            val remainingItems = if (topVisibleIndex != null) total - topVisibleIndex - 1 else null
